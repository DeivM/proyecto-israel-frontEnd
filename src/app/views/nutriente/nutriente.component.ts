...
@Component({
  selector: 'app-nutriente',
  templateUrl: './nutriente.component.html',
  styleUrls: ['./nutriente.component.css']
})
export class NutrienteComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.indexParameters.modulo = modules.nutriente.name;
  ...
  getDataForm(id: number) {
    this.itemSub = this.httpService.GetDataForm(id, undefined, modules.nutriente.name)
      .subscribe(item => {
        if (item.data?.data) {
  ...
  onSubmit() {
    ...
    this.itemsSub = this.httpService.PostPut(this.itemForm.value, modules.nutriente.name, false, undefined, this.itemForm.value.nutId)
      .subscribe(data => {
        this.closeBtnClick();
  ...
  delete(id:number)
  {
    ...
    this.itemsSub = this.httpService.deleteItems( modules.nutriente.name,  undefined, itemsDelete)
    .subscribe(data => {
      this.closeBtnClick();
